...
path = os.path.join("frontend", "assets", "ventana_sad_2.ui")
window_name, base_class = uic.loadUiType(path)

class VentanaSad2(window_name, base_class):
    ...
    def __init__(self):
        ...
        self.movie = QMovie(os.path.join("frontend", "assets", "sad-pikachu.gif"))
